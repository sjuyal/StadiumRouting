       ...
       // final EditText et = (EditText)findViewById(R.id.eTSeatNo) ;
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String seatNumber = String.valueOf(spin1.getSelectedItem())+"_"+String.valueOf(spin2.getSelectedItem());
                Log.d("Soccer" , "Sea number before initnt : " + seatNumber);
                intent.putExtra("message", seatNumber);
