package com.trex.app.TRexSoccer.screens;
...
import com.trex.app.TRexSoccer.entities.Player;
...
public class Play implements Screen {
    ...
    public void render(float delta) {
        ...
        font.draw(spriteBatch, "Source", 540, 450);
        font.draw(spriteBatch, "Destination", 540, 400);
        font.draw(spriteBatch, "Path", 540, 355);
    ...
    public void show()  {
        ...
        //seatNo="[{\"xCoordinate\":6.0,\"yCoordinate\":32.0},{\"xCoordinate\":27.0,\"yCoordinate\":0.0}]";
        //System.out.println(this.seatNo);
        makePath(map);
        JsonValue jsonValue = new JsonReader().parse(seatNo);
        ...
        while(iter.hasNext()){
            if(i==0){
                ...
                y = jV.getInt("xCoordinate");
                x = jV.getInt("yCoordinate");
            }else{
                JsonValue jV = iter.next();
                newY = jV.getInt("xCoordinate");
                newX = jV.getInt("yCoordinate");
            }
            i++;
        }
